...
export const FloatButton = ({ title, highlightText, highlightColor, style, onClick }) => {
    ...
    return (
        <button {...{onClick, style}} className="button floating">{ titleWithoutHighlight }<span style={{ color: highlightColor }} className="text-font-rumpel text-blue">{ titleWithHighlight }</span></button>
    )
}
...
export const InvertedButton = ({ title, style, onClick }) => {
    return (
        <button {...{onClick, style}} className="button inverted">{ title }</button>
    )
}
...
export const DefaultButton = ({ title, style, onClick, defaultInvert }) => {
    return (
        <button {...{onClick, style}} className={defaultInvert ? "button default-invert" : "button default"} >{ title }</button>
    )
}
